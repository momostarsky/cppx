...
void
parseSubs(DicomItem *ite) {///NOLINT
...
void
parseValueFieldWithUndefinedLength(FILE *reader, DicomItem *ite) {///NOLINT
...
void
ExplicitVrLittleEndianReader::ReadDataset(std::list<DicomItem> &items, uint32_t depath) {///NOLINT
